...
if __name__ == "__main__":
    ...
    class EvalConfig:
        ...
        data_config: str = "g1_block_stacking" # Fixed for G1
        steps: int = 150
        trajs: int = 1
        action_horizon: int = 16
        video_backend: str = "torchvision_av" # Changed for G1 compatibility
        dataset_path: str = "demo_data/G1_BlockStacking_Dataset" # Fixed for G1
        embodiment_tag: str = "new_embodiment" # Fixed for G1
        model_path: str = "output/G1_BlockStacking_Dataset/" # Fixed for G1 output directory
