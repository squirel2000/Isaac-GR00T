...
class G1BlockStackingDataConfig(BaseDataConfig):
...
class G1CubePickAndPlaceDataConfig(BaseDataConfig):
...
class G1CanPickAndSortDataConfig(BaseDataConfig):
    video_keys = ["video.camera"]
    state_keys = [
        "state.left_arm",
        "state.right_arm",
...
DATA_CONFIG_MAP = {
    ...
    "g1_block_stacking": G1BlockStackingDataConfig(),
    "g1_cube_pick_and_place": G1CubePickAndPlaceDataConfig(),
    "g1_can_pick_and_sort": G1CanPickAndSortDataConfig(),
}